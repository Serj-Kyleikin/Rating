...
class MainModel extends Model {
    ...
    public function prepareRating() {
        ...
        $rating_errors = [
            '0' => '0:Проголосовать могут только зарегистрированные пользователи!',
            '1' => '1:Вы уже проголосовали!',
            ...
            if(isset($_COOKIE['user'])) {
                ...
                if($info == null or $info['user_id'] == NULL) {                  // Не голосовал за этот пост ранее
                    ...
                    if($info['votes_articleID'] == $_POST['article_id']) {       // Обновление рейтинга
                        ...
                        } else return $rating_errors[2];      // Попытка добавить рейтинг к несуществующему посту
                    }
                ...
                } else return $rating_errors[1];      // Повторное голосование

            } else return $rating_errors[0];          // Неавторизованный пользователь

            return $response;                         // Обновлённые данные рейтинга

        } else return $rating_errors[2];              // Зафиксирована попытка обмана
    }
}