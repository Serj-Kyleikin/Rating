...
class Application extends AjaxModel {
    ...
    // Получение среднего рейтинга поста и списка id проголосовавших за пост из данных, хранящихся в URI изображения этого поста
    ...
    // Метод показывает средний рейтинг каждого поста, число проголосовавших и опционально оценку авторизованного пользователя

	public function showRating() {

        $data = 'DB';
        $this->getpInfo();             // Запрос рейтинга поста

        // Если это авторизованный пользователь, то показ его оценок

        if(isset($_COOKIE['name'])) {

            $this->getuInfo();        // Запрос данных авторизованного пользователя
